...
Vue.component("purple_header_component_1722594278", {
    template: `
            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <nav id="desktop-navigation" class="hidden md:flex md:grow">
                    ...
                    <ul id="desktop-menu-links" class="flex grow justify-center flex-wrap items-center">
                        <li><a id="No Code Web3-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" :class="[textStylePrimary, hoverTextStylePrimary]" href="No Code Web3.html">No Code Web3</a></li>
                        <li><a id="Tools-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Tools.html" :class="[textStylePrimary, hoverTextStylePrimary]">Tools</a></li>
                        <li><a id="Dapp Development-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Dapp Development.html" :class="[textStylePrimary, hoverTextStylePrimary]">Dapp Development</a></li>
                        <li><a id="Create Dapps-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Create Dapps.html" :class="[textStylePrimary, hoverTextStylePrimary]">Create Dapps</a></li>
                        <li><a id="Earn with Web3-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Earn with Web3.html" :class="[textStylePrimary, hoverTextStylePrimary]">Earn with Web3</a></li>
                    </ul>
                ...
                <div id="mobile-menu" class="md:hidden flex items-center ml-4" x-data="{ expanded: false }">
                    ...
                    <nav id="mobile-nav" class="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" x-ref="mobileNav" :style="expanded ? 'max-height: ' + $refs.mobileNav.scrollHeight + 'px; opacity: 1' : 'max-height: 0; opacity: .8'" @click.outside="expanded = false" @keydown.escape.window="expanded = false" x-cloak>
                        <ul id="mobile-nav-list" class="border border-transparent rounded-lg px-4 py-1.5" :class="signUpButtonGradient">
                            <li><a id="mobile-No Code Web3-link" class="flex font-medium text-sm py-1.5" href="No Code Web3.html" :class="[textStylePrimary,hoverTextStylePrimary]">No Code Web3</a></li>
                            <li><a id="mobile-Tools-link" class="flex font-medium text-sm py-1.5" href="Tools.html" :class="[textStylePrimary,hoverTextStylePrimary]">Tools</a></li>
                            <li><a id="mobile-Dapp Development-link" class="flex font-medium text-sm py-1.5" href="Dapp Development.html" :class="[textStylePrimary,hoverTextStylePrimary]">Dapp Development</a></li>
                            <li><a id="mobile-Create Dapps-link" class="flex font-medium text-sm py-1.5" href="Create Dapps.html" :class="[textStylePrimary,hoverTextStylePrimary]">Create Dapps</a></li>
                            <li><a id="mobile-Earn with Web3-link" class="flex font-medium text-sm py-1.5" href="Earn with Web3.html" :class="[textStylePrimary,hoverTextStylePrimary]">Earn with Web3</a></li>
                        </ul>
                    </nav>
