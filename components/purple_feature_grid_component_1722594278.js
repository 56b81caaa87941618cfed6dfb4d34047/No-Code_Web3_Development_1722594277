...
Vue.component("purple_feature_grid_component_1722594278", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            <div id="feature-1-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-1-title-container"><h4 id="feature-1-title" class="flex-1 font-medium" :class="textSecondaryStyle">No-Code Web3 for Effortless Development</h4></div>
            </div>
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm" :class="textPrimaryStyle">Unlock the power of blockchain without writing a single line of code. Our no-code platform empowers you to build decentralized applications (dapps) and web3 solutions with ease, streamlining the development process and democratizing access to this revolutionary technology.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            <div id="feature-2-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-2-title-container"><h4 id="feature-2-title" class="flex-1 font-medium" :class="textSecondaryStyle">Make Infinite: Your No-Code Powerhouse</h4></div>
            </div>
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm" :class="textPrimaryStyle">Harness the full potential of Make Infinite, our flagship no-code tool designed specifically for web3 creators. From deploying smart contracts to creating user-friendly dapps, Make Infinite puts the entire blockchain ecosystem at your fingertips without the need for technical expertise.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            <div id="feature-3-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-3-title-container"><h4 id="feature-3-title" class="flex-1 font-medium" :class="textSecondaryStyle">Explore the No-Code Web3 Ecosystem</h4></div>
            </div>
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm" :class="textPrimaryStyle">Discover a wide range of no-code platforms tailored for web3 development. Compare and contrast their unique features, capabilities, and real-world success stories to find the perfect fit for your blockchain project.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            <div id="feature-4-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-4-title-container"><h4 id="feature-4-title" class="flex-1 font-medium" :class="textSecondaryStyle">Empower Technical Creators with No-Code</h4></div>
            </div>
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm" :class="textPrimaryStyle">Even for experienced developers, no-code tools offer unparalleled efficiency and streamlined workflows. Seamlessly integrate smart contracts, wallets, and other blockchain functionalities into your dapps while leveraging the power of visual programming and intuitive interfaces.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            <div id="feature-5-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-5-title-container"><h4 id="feature-5-title" class="flex-1 font-medium" :class="textSecondaryStyle">Create Staking Dapps without Coding</h4></div>
            </div>
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm" :class="textPrimaryStyle">Unlock the potential of staking dapps with our no-code solutions. Explore real-world use cases, learn how to develop secure and user-friendly crypto wallets, and dive into the world of DeFi yield farming dapps – all without writing a single line of code.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            <div id="feature-6-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-6-title-container"><h4 id="feature-6-title" class="flex-1 font-medium" :class="textSecondaryStyle">Monetize Web3 Beyond Dapps</h4></div>
            </div>
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm" :class="textPrimaryStyle">Discover lucrative opportunities in the web3 space beyond dapp development. Identify market gaps, explore successful business models, and gain insights into creating and monetizing innovative crypto tools and services that cater to the ever-growing blockchain ecosystem.</p></div>
        </div>
    </div>`,
        data() {
            return {
